## 2026-01-26 - [Adult PIN Plaintext Storage]

**Vulnerability:** Adult PIN was stored in plaintext in the database (`household_settings` table), allowing anyone with database access to view the PIN.
